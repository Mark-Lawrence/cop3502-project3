...
public class LucyTattooParlor {
	...
	public static void main (String[] args){
		...
		System.out.println("Welcome to Lucy's Tattoo Parlor! Enter a customer's name to begin or 'Print Waitlist' to see tomorrow's appointments.");
		while (loopControl==0){
	...
	/**
	 * Computes how many minutes of work the specified tattoo artist has already scheduled.
